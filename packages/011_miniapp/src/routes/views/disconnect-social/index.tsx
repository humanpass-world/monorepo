import {
  getGetMiniappVerifiedSocialListQueryKey,
  useDeleteMiniappVerifiedSocialDisconnect,
...
export default function DisconnectSocial() {
  ...
  const { mutateAsync: deleteMiniappVerifiedSocialDisconnect } =
    useDeleteMiniappVerifiedSocialDisconnect({
      mutation: {
        onSuccess: () => {
          queryClient.invalidateQueries({
            queryKey: getGetMiniappVerifiedSocialListQueryKey(),
          });
        },
      },
    });
  ...
  const handleSubmit = async () => {
    setIsLoading(true);
    await deleteMiniappVerifiedSocialDisconnect({
      data: {
        verifiedSocialId: id,
      },
    });
